...
**OSS版では、CloudSearchを用いた全文検索機能はスタブ化されていることにご注意ください。詳細は以下のIssueをご参照ください。**   
[pxr-linkage issue#79](https://github.com/Personal-Data-Linkage-Module/pxr-linkage/issues/79)
