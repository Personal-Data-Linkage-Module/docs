...
<tbody>
<tr class="odd">
<td><p>$ cd ~/pxr-local-ctoken-service</p>
<p>$ npm i</p>
...
<tbody>
<tr class="odd">
<td><p>$ cd ~/ddl/db/pxr-local-ctoken-service</p>
...
<p>・右側に表示された画面で、ファイルを開くを選択し、ddlリポジトリのdb\pxr-local-ctoken-service配下にあるcreateDB.sqlを開く</p>
<p>・実行を選択し、「ログイン/グループロール」にpxr_local_ctoken_userが作成されていること、pxr_podのスキーマ配下にpxr_local_ctokenが作成されていることを確認する</p>
<p>・クエリツール画面で、ddlリポジトリのdb\pxr-local-ctoken-service配下にあるcreateTable.sqlを開いて、実行する</p></td>
</tr>
</tbody>
</table>
...
<p><a
href="http://localhost">http://localhost</a>:3009/api-docs/</p></td>
<td><p>Webブラウザで以下にアクセスし、Swaggerが表示されること</p>
<p><a
href="http://localhost">http://localhost</a>:3009/api-docs/</p></td>
</tr>
